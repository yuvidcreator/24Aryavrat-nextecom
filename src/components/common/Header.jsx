                ...
                <div className="w-10/12 flex justify-end items-center">
                    ...
                    <div className="hidden md:flex ml-auto">
                        <div className="hidden ml-4 md:flex items-center space-x-4 text-[#0B0B45]">
                            ...
                            {/* Cart Functionality */}
                            <div ref={ref} className="cart-sidebar w-96 absolute top-0 right-0 bg-gray-100 p-10 min-h-screen transform transition-transform translate-x-full">
                                <h2 className="text-xl font-bold text-center mt-8">This is my Cart</h2>
                                ...
                                <div className="p-2">
                                    ...
                                    <ol className="list-decimal">
                                        <li>
                                            <div className="flex item my-6">
                                                <div className="w-2/3">Desi Ghee</div>
                                                <div className="flex w-1/3 justify-center items-center">
                                                    <AiOutlineMinusCircle className="mx-2 cursor-pointer" /> 1 <AiOutlinePlusCircle className="mx-2 cursor-pointer" />
                                                </div>
                                            </div>
                                        </li>
                                    </ol>
